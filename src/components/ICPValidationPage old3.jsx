          ...
          <main className="max-w-7xl mx-auto px-6 py-12">
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border-2 border-purple-500/30 rounded-2xl p-8 mb-8 backdrop-blur-sm">
              ...
              <p className="text-slate-300 mb-6">
                Based on your ICP, here's how Barry will score each lead (0-100 points):
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                <div className="bg-slate-900/50 rounded-xl p-4 border border-purple-500/30 text-center">
                  ...
                  <div className="text-xs text-slate-400 mb-2">POINTS</div>
                  <div className="text-sm text-white font-semibold">Title Match</div>
                  <p className="text-xs text-slate-400 mt-2">Exact or close job title</p>
                </div>
                <div className="bg-slate-900/50 rounded-xl p-4 border border-pink-500/30 text-center">
                  <div className="text-3xl font-bold text-pink-400 mb-1">25</div>
                  <div className="text-xs text-slate-400 mb-2">POINTS</div>
                  <div className="text-sm text-white font-semibold">Industry Match</div>
                  <p className="text-xs text-slate-400 mt-2">Target industry fit</p>
                </div>
                <div className="bg-slate-900/50 rounded-xl p-4 border border-cyan-500/30 text-center">
                  ...
                  <div className="text-xs text-slate-400 mb-2">POINTS</div>
                  <div className="text-sm text-white font-semibold">Company Size</div>
                  <p className="text-xs text-slate-400 mt-2">Employee count range</p>
                </div>
                <div className="bg-slate-900/50 rounded-xl p-4 border border-blue-500/30 text-center">
                  <div className="text-3xl font-bold text-blue-400 mb-1">15</div>
                  <div className="text-xs text-slate-400 mb-2">POINTS</div>
                  <div className="text-sm text-white font-semibold">Not Avoided</div>
                  <p className="text-xs text-slate-400 mt-2">Not in avoid list</p>
                </div>
                <div className="bg-slate-900/50 rounded-xl p-4 border border-green-500/30 text-center">
                  ...
                  <div className="text-xs text-slate-400 mb-2">POINTS</div>
                  <div className="text-sm text-white font-semibold">Data Quality</div>
                  <p className="text-xs text-slate-400 mt-2">Complete contact info</p>
                </div>
              </div>

              <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-700">
                <h4 className="text-lg font-bold text-white mb-4">Match Quality Tiers:</h4>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-4">
                    ...
                    <div className="text-3xl font-bold text-green-400 mb-1">85-100</div>
                    <div className="text-xs text-slate-300">Dream leads - pursue immediately</div>
                  </div>
                  <div className="bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="text-2xl">🟡</div>
                      <div className="font-bold text-white">Good</div>
                    </div>
                    <div className="text-3xl font-bold text-yellow-400 mb-1">70-84</div>
                    <div className="text-xs text-slate-300">Solid matches worth pursuing</div>
                  </div>
                  <div className="bg-orange-500/20 border border-orange-500/30 rounded-lg p-4">
                    ...
                    <div className="text-3xl font-bold text-orange-400 mb-1">50-69</div>
                    <div className="text-xs text-slate-300">Maybes - test the waters</div>
                  </div>
                </div>
              </div>
            </div>
