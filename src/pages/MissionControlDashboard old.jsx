      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8 animate-fadeIn">
            ...
            {leads.length === 0 && (
              <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-2 border-yellow-500/30 rounded-2xl p-8 text-center backdrop-blur-xl">
                <div className="text-6xl mb-4">⚠️</div>
                <h3 className="text-3xl font-bold text-white mb-3 font-mono">AWAITING LAUNCH</h3>
                <p className="text-gray-300 mb-6 font-mono max-w-2xl mx-auto">
                  Your ICP intelligence is ready. Review and approve to begin target acquisition.
                </p>
                <button
                  onClick={() => setActiveTab('icp-intel')}
                  className="bg-gradient-to-r from-yellow-500 to-orange-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:from-yellow-600 hover:to-orange-700 transition-all shadow-2xl shadow-yellow-500/50 font-mono"
                >
                  📋 REVIEW ICP INTEL →
                </button>
              </div>
            ...
            {leads.length === 0 ? (
              <div className="text-center py-20">
                ...
                <p className="text-gray-400 mb-8 font-mono">
                  Complete launch sequence to begin target acquisition!
                </p>
              </div>
            ) : (
              <>
