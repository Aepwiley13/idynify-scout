 ...
 *
 * missionFields (Step 4) — structured strategy parameters:
 *   outcome_goal: string      — what this mission is trying to achieve
 *   engagement_style: string  — depth/intensity of engagement
 *   timeframe: string         — deadline or urgency window
 *   next_step_type: string    — type of action Barry should plan toward
 */
export function createMissionFromTemplate(goalId, missionName, contacts = [], missionFields = {}) {
  ...
  return {
    ...
    // Step 4: Structured mission strategy fields
    outcome_goal: missionFields.outcome_goal || null,
    engagement_style: missionFields.engagement_style || null,
    timeframe: missionFields.timeframe || null,
    next_step_type: missionFields.next_step_type || null,
    ...
    // Step 4: Micro-sequence suggestions from Barry (approval-gated)
    microSequence: null, // Will be populated by barryGenerateMissionSequence
